...
<div class="view">
    <div class="box box-info">
        <div class="box-header">
            ...
            <h5 class="box-title">Daftar Peserta Asuransi Kredit Guna Bhakti</h5>
            <!-- tools box -->
        ...
        <div class="box-body">
            <div class="row">
                <form class="form-horizontal" id="form">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-4 control-label"><small>Search Customer</small></label>
                            <div class="col-sm-6">
                                <input type="text" name="customer" class="form-control" id="username" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    $('#cari').click(function(){
        ...
        $.post("<?php echo base_url()?>kgb/polis/getData",form,function(data){
            $('#data').html(data);
        });
    });
